                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li>
                                <a href="javascript:;" onclick="picture_add('添加图片','picture-add.html')"><i class="Hui-iconfont">&#xe613;</i> 图片</a>
                            </li>
                            <li>
                                <a href="javascript:;" onclick="product_add('添加产品','product-add.html')"><i class="Hui-iconfont">&#xe620;</i> 产品</a>
                            </li>
                            <li>
